...
export const Privacidad = () => {
  return (
    <div className='privacidadContainer'>
        ...
        <p className='text-white'>El presente Política de Privacidad establece los términos en que RestoMaky usa y 
        ...
        <p className='text-white'>
        <strong className='text-white'>Información que es recogida</strong>
        </p>
        <p className='text-white'>Nuestro sitio web podrá recoger información personal por ejemplo: Nombre información de contacto como su dirección de correo electrónica e información demográfica. 
        ...
        <p className='text-white'>
            <strong className='text-white'>Uso de la información recogida</strong>
        </p>
        <p className='text-white'>Nuestro sitio web emplea la información con el fin de proporcionar el mejor servicio posible, particularmente para mantener un registro de usuarios, de pedidos en caso que aplique, 
        ...
        <p className='text-white'>RestoMaky está altamente comprometido para cumplir con el compromiso de mantener su información segura. Usamos los sistemas más avanzados y los actualizamos constantemente para 
            asegurarnos que no exista ningún acceso no autorizado.</p>
        <p>
            <strong className='text-white'>Cookies</strong>
        </p>
        <p className='text-white'>Una cookie se refiere a un fichero que es enviado con la finalidad de solicitar permiso para 
        ...
        <p className='text-white'>Nuestro sitio web emplea las cookies para poder identificar las páginas que son visitadas y su frecuencia. Esta información es empleada únicamente para análisis estadístico y después 
        ...
        <p className='text-white'>Este sitio web pudiera contener en laces a otros sitios que pudieran ser de su interés. Una vez que usted de clic en estos enlaces y abandone nuestra página, ya no tenemos control 
        ...
        <p className='text-white'><strong>Control de su información personal</strong></p>
        <p className='text-white'>En cualquier momento usted puede restringir la recopilación o el uso de la información personal que es proporcionada a nuestro sitio web. Cada vez que se le solicite rellenar 
        ...
        <p className='text-white'>Esta compañía no venderá, cederá ni distribuirá la información personal que es recopilada sin su 
            consentimiento, salvo que sea requerido por un juez con un orden judicial.
        </p>
        <p className='text-white'>RestoMaky Se reserva el derecho de cambiar los términos de la presente Política de Privacidad 
