    ...
    <>
      ...
      <div className='containerInicioId' id='inicio'>Elemento oculto</div>
        ...
        <div className='img-container'>
          <div className='container-img-individual'><img onClick={() => openModalImg('Maky 2', '10 Tempura C – 5 Ciboulette – 5 Sésamo – 5 Nori', '_Maky_2-min.JPG')} className='img-menu-home' src={require('./../../assets/img/home/_Maky_2-min.JPG')} alt="ASD" /></div>
          <div className='container-img-individual'><img onClick={() => openModalImg('Maky 3', '10 Tempura A – 10 Nori – 5 Sésamo – 5 Nori', '_Maky_3-min.JPG')} className='img-menu-home' src={require('./../../assets/img/home/_Maky_3-min.JPG')} /></div>
