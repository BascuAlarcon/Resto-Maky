...
function CarouselFadeExample() {
  ...
  const [imagen, setImagen] = useState('img_galeria_01.JPG'); 
    ...
    <>
      ...
      <div className='containerInicioId' id='inicio'>Elemento oculto</div>
        ...
        <div className='img-container'>
          <div className='container-img-individual'><img onClick={() => openModalImg('Maky 2', '10 Tempura C – 5 Ciboulette – 5 Sésamo – 5 Nori', 'img_galeria_01.JPG')} className='img-menu-home' src={require('./../../assets/img/home/img_galeria_01.JPG')} alt="" /></div>
          <div className='container-img-individual'><img onClick={() => openModalImg('Maky 3', '10 Tempura A – 10 Nori – 5 Sésamo – 5 Nori', 'img_galeria_01.JPG')} className='img-menu-home' src={require('./../../assets/img/home/img_galeria_02.JPG')} alt=""/></div>
          <div className='container-img-individual'><img onClick={() => openModalImg('Maky 4', '10 Tempura A  10 Tempura B  10 Nori   5 Sésamo  5 Ciboulette', 'img_galeria_01.JPG')} className='img-menu-home' src={require('./../../assets/img/home/img_galeria_03.JPG')} alt="" /></div>
          <div className='container-img-individual'><img onClick={() => openModalImg('Maky 5', '10 Tempura A – 10 Tempura B – 10 Queso Crema - 10 Nori – 5 Sésamo – 5 Ciboulette', 'img_galeria_01.JPG')} className='img-menu-home' src={require('./../../assets/img/home/img_galeria_04.JPG')} alt="" /></div>
        </div>
        <div className='img-container'>
          <div className='container-img-individual'><img onClick={() => openModalImg('Maky 6', '10 Tempura C – 10 Tempura B – 10 Palta - 10 Nori – 5 Sésamo – 5 Ciboulette', 'img_galeria_01.JPG')} className='img-menu-home' src={require('./../../assets/img/home/img_galeria_05.JPG')} alt="" /></div>
          <div className='container-img-individual'><img onClick={() => openModalImg('Maky 7', '10 Tempura A – 10 Tempura C – 20 Nori – 10 Sésamo – 10 Ciboulette', 'img_galeria_01.JPG')} className='img-menu-home' src={require('./../../assets/img/home/img_galeria_06.JPG')} alt="" /></div>
          <div className='container-img-individual'><img onClick={() => openModalImg('Tempura F', 'Champiñones - Pollo - Queso Crema', 'img_galeria_01.JPG')} className='img-menu-home' src={require('./../../assets/img/home/img_galeria_07.JPG')} alt="" /></div>
          <div className='container-img-individual'><img onClick={() => openModalImg('Tempura C', 'Pollo - Queso Crema - Cebollín', 'img_galeria_01.JPG')} className='img-menu-home' src={require('./../../assets/img/home/img_galeria_08.JPG')} alt="" /></div>
        </div>
        <div className='img-container'>
          <div className='container-img-individual'><img onClick={() => openModalImg('Promo 30 Fríos', '10 Nori – 10 Sésamo – 10 Ciboulette', 'img_galeria_01.JPG')} className='img-menu-home' src={require('./../../assets/img/home/img_galeria_09.JPG')} alt="" /></div>
          <div className='container-img-individual'><img onClick={() => openModalImg('Promo 30 Fríos', '10 Nori – 10 Sésamo – 10 Ciboulette', 'img_galeria_01.JPG')} className='img-menu-home' src={require('./../../assets/img/home/img_galeria_10.JPG')} alt="" /></div>
          <div className='container-img-individual'><img onClick={() => openModalImg('Promo 50', '20 Tempura A/B – 10 Ciboulette – 10 Sésamo – 10 Nori', 'img_galeria_01.JPG')} className='img-menu-home' src={require('./../../assets/img/home/img_galeria_11.JPG')} alt="" /></div>
          <div className='container-img-individual'><img onClick={() => openModalImg('Tempuras 60', '30 Tempura A/B/C – 10 Ciboulette – 10 Sésamo – 10 Nori', 'img_galeria_01.JPG')} className='img-menu-home' src={require('./../../assets/img/home/img_galeria_12.JPG')} alt="" /></div>
        </div> 
      </div>  
      ...
      <Modal 
        ...
        <Modal.Body>
          ...
          <img className='img-modal-home mb-4' src={require(`./../../assets/img/home/${imagen}`)} alt="" />  
        </Modal.Body>
      </Modal>
    </>
  );
